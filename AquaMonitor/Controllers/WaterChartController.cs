...
namespace AquaMonitor.Web.Controllers
{
    ...
    [Route("[controller]")]
    [ApiController]
    public class WaterChartController : ControllerBase
    {
        private readonly AquaDbContext dbContext;
        private readonly ILogger<WaterChartController> logger;
        ...
        public WaterChartController(ILogger<WaterChartController> logger, AquaDbContext dbContext)
        {
            this.logger = logger;
        ...
        {
            logger.LogInformation("Water Chart has been requested");
