...
/// <summary>
    ...
    public class Uln2003Beta : IDisposable
    {
        /// <summary>
        ...
        public Uln2003Beta(int pin1, int pin2, int pin3, int pin4, GpioController controller = null, bool shouldDispose = true, int stepsToRotate = 4096)
        {
            _pin1 = pin1;
            _pin2 = pin2;
            _pin3 = pin3;
